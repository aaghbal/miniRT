...
/*   Updated: 2023/09/30 18:19:54 by aaghbal          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_intersect *cone_intersect(t_shape s, t_ray ray)
{
	...
	data.a = pow(r.direction.x, 2) + ((pow(r.direction.y, 2) * -1)) + pow(r.direction.z, 2);
	data.b = (2 * r.origine.x * r.direction.x) - (2 * r.origine.y * r.direction.y) + (2 * r.origine.z * r.direction.z);
	data.c = pow(r.origine.x, 2) + ((pow(r.origine.y, 2) * -1) + pow(r.origine.z, 2));
